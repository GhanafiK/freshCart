...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [CarouselModule,RouterLink,IntNumPipe,FormsModule,SearchPipe,NgClass],
...
export class HomeComponent implements OnInit,OnDestroy{
  ...
  allCategorySubscribe!:Subscription
  ...
  ngOnInit(): void {
    ...
    this.allCategorySubscribe=this._CategoriesService.getAllCategories().subscribe({
      next:(res)=>{
  ...
  ngOnDestroy(): void {
    ...
    this.allCategorySubscribe?.unsubscribe()
    this.addtocart?.unsubscribe()
    this.getProductsInWish?.unsubscribe()
    this.UpdateWishNum?.unsubscribe()
  }
}
